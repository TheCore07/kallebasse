...
import {ClockIcon, UserIcon, CogIcon, DocumentTextIcon, TicketIcon} from "@heroicons/react/24/outline";
...
export const menuItems: MenuItem[] = [
    ...
    { label: "Tickets", path: "/tickets", icon: <TicketIcon className="h-5 w-5"/> },
